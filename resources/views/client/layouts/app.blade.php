...
<body>
 ...
 <!-- Page Wrapper -->
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar"  style="background :#3F51B5;">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('client.dashboard') }}">
        ...
        <div class="sidebar-brand-text mx-3">SD Gateway<sup></sup></div>
      </a>
